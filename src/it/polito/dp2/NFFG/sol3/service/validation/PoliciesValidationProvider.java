...
public class PoliciesValidationProvider implements MessageBodyReader<Policy> {
	String responseBodyTemplate;

	@Override
	public boolean isReadable(Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType) {
		return Policy.class.equals(type);
	}
	...
	public Policy readFrom(Class<Policy> type, Type genericType, Annotation[] annotations, MediaType mediaType, MultivaluedMap<String, String> httpHeaders, InputStream entityStream) throws IOException, WebApplicationException {
		...
		try {				
			InputStream schemaStream = PoliciesValidationProvider.class.getResourceAsStream("/xsd/nffgVerifier.xsd");
		...
		try {
			return (Policy) unmarshaller.unmarshal(entityStream);
